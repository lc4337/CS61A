...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ndice0 = strategy0(score0, score1)
            if feral_hogs and abs(ndice0 - pg0) == 2:
                score0 += 3
            pg0 = take_turn(ndice0, score1, dice)
            score0 += pg0
            if is_swap(score0, score1):
                score0, score1 = score1, score0
            say = say(score0, score1)
        else:
            ndice1 = strategy1(score1, score0)
            if feral_hogs and abs(ndice1 - pg1) == 2:
                score1 += 3
            pg1 = take_turn(ndice1, score0, dice)
            score1 += pg1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if score - last_score > running_high:
            print(score - last_score, "point(s)! That's the biggest gain yet for Player", who)
...
def make_averaged(original_function, trials_count=50000):
...
def max_scoring_num_rolls(dice=six_sided, trials_count=50000):
...
def final_strategy(score, opponent_score, cutoff=4, num_rolls=6):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if is_swap(score + 1, opponent_score) and opponent_score - score - 1 >= cutoff:
        return 10
    if is_swap(score + bacon, opponent_score):
        if opponent_score - score - bacon >= cutoff:
            return 0 
        else:
            return num_rolls
    if bacon + score >= 100:
